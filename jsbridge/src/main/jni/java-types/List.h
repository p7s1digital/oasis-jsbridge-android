 ...
 */
#ifndef _JSBRIDGE_JAVATYPES_LIST_H
#define _JSBRIDGE_JAVATYPES_LIST_H

#include "JavaType.h"

namespace JavaTypes {

class List : public JavaType {

public:
  List(const JsBridgeContext *, std::unique_ptr<const JavaType> &&componentType);
