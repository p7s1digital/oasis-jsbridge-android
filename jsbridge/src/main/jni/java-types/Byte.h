 ...
 */
#ifndef _JSBRIDGE_JAVATYPES_BYTE_H
#define _JSBRIDGE_JAVATYPES_BYTE_H
...
public:
  ...
  duk_ret_t pushArray(const JniLocalRef<jarray> &, bool expand) const override;
