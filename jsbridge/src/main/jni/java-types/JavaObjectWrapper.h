 ...
 */
#ifndef _JSBRIDGE_JAVATYPES_JAVAOBJECTWRAPPER_H
#define _JSBRIDGE_JAVATYPES_JAVAOBJECTWRAPPER_H
...
class JavaObjectWrapper : public JavaType {

public:
  JavaObjectWrapper(const JsBridgeContext *);
